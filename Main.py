...
buying_power = round(float(robin_stocks.profiles.load_account_profile()["buying_power"]), 2)
portfolio_cash = round(float(robin_stocks.profiles.load_account_profile()["portfolio_cash"]), 2)
print("BUYING POWER: ", buying_power)
print("PORTFOLIO_CASH: ", portfolio_cash)
